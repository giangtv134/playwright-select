(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["playwright-select"] = {}));
})(this, (function (exports) { 'use strict';

  var injectedScript;
  var hasRequiredInjectedScript;

  function requireInjectedScript () {
  	if (hasRequiredInjectedScript) return injectedScript;
  	hasRequiredInjectedScript = 1;
  	...
  	injectedScript = __toCommonJS(injectedScript_exports);
  	...
  	function closestCrossShadow(element, css, scope) {
  	  while (element) {
  	    ...
  	    if (scope && closest !== scope && (closest == null ? undefined : closest.contains(scope)))
  	      return;
  	    if (closest)
  	      return closest;
  	    element = enclosingShadowHost(element);
  	...
  	function normalizeWhiteSpace(text) {
  	  let result = normalizedWhitespaceCache == null ? undefined : normalizedWhitespaceCache.get(text);
  	  if (result === undefined) {
  	    result = text.replace(/\u200b/g, "").trim().replace(/\s+/g, " ");
  	    normalizedWhitespaceCache == null ? undefined : normalizedWhitespaceCache.set(text, result);
  	  }
  	  return result;
  	}
  	...
  	function getElementAccessibleDescription(element, includeHidden) {
  	  ...
  	  let accessibleDescription = cache == null ? undefined : cache.get(element);
  	  if (accessibleDescription === undefined) {
  	    ...
  	    cache == null ? undefined : cache.set(element, accessibleDescription);
  	  }
  	...
  	function getTextAlternativeInternal(element, options) {
  	  ...
  	  if (!options.includeHidden) {
  	    const isEmbeddedInHiddenReferenceTraversal = !!((_a = options.embeddedInLabelledBy) == null ? undefined : _a.hidden) || !!((_b = options.embeddedInDescribedBy) == null ? undefined : _b.hidden) || !!((_c = options.embeddedInNativeTextAlternative) == null ? undefined : _c.hidden) || !!((_d = options.embeddedInLabel) == null ? undefined : _d.hidden);
  	...
  	function getComponentKey(reactElement) {
  	  var _a, _b;
  	  return (_b = reactElement.key) != null ? _b : (_a = reactElement._currentElement) == null ? undefined : _a.key;
  	}
  	function getChildren(reactElement) {
  	  ...
  	  const isKnownElement = (reactElement2) => {
  	    var _a;
  	    const elementType = (_a = reactElement2._currentElement) == null ? undefined : _a.type;
  	...
  	function getProps(reactElement) {
  	  ...
  	  const props = (
  	    ...
  	    ((_a = reactElement._currentElement) == null ? undefined : _a.props)
  	  );
  	...
  	function buildComponentsTree(reactElement) {
  	  ...
  	  const rootElement = (
  	    ...
  	    reactElement._hostNode || ((_a = reactElement._renderedComponent) == null ? undefined : _a._hostNode)
  	  );
  	...
  	function buildComponentsTreeVue3(instance) {
  	  ...
  	  function getInstanceName(instance2) {
  	    ...
  	    if (instance2.root === instance2)
  	      return "Root";
  	    for (const key in (_b = (_a = instance2.parent) == null ? undefined : _a.type) == null ? undefined : _b.components) {
  	      if (((_c = instance2.parent) == null ? undefined : _c.type.components[key]) === instance2.type)
  	        return saveComponentName(instance2, key);
  	    }
  	    for (const key in (_d = instance2.appContext) == null ? undefined : _d.components) {
  	  ...
  	  function getInternalInstanceChildren(subTree) {
  	    ...
  	    return list.filter((child) => {
  	      var _a;
  	      return !isBeingDestroyed(child) && !((_a = child.type.devtools) == null ? undefined : _a.hide);
  	    });
  	  }
  	...
  	var Highlight = class {
  	  ...
  	  clearHighlight() {
  	    ...
  	    for (const entry of this._highlightEntries) {
  	      (_a = entry.highlightElement) == null ? undefined : _a.remove();
  	      (_b = entry.tooltipElement) == null ? undefined : _b.remove();
  	    }
  	    this._highlightEntries = [];
  	    this._highlightOptions = {};
  	    this._glassPaneElement.style.pointerEvents = "none";
  	        ...
  	        for (let index = 0; index < lines.length; index++) {
  	          ...
  	          if (options.tooltipListItemSelected) {
  	            ...
  	            element.addEventListener("click", () => {
  	              var _a;
  	              return (_a = options.tooltipListItemSelected) == null ? undefined : _a.call(options, index);
  	            });
  	          }
  	        }
  	  ...
  	  firstBox() {
  	    var _a;
  	    return (_a = this._highlightEntries[0]) == null ? undefined : _a.box;
  	  }
  	  ...
  	  _highlightIsUpToDate(elements, options) {
  	    ...
  	    if (options.tooltipFooter !== this._highlightOptions.tooltipFooter)
  	      return false;
  	    if (((_a = options.tooltipList) == null ? undefined : _a.length) !== ((_b = this._highlightOptions.tooltipList) == null ? undefined : _b.length))
  	      return false;
  	...
  	function selectorForSimpleDomNodeId(injectedScript, id) {
  	  const element = lastDom == null ? undefined : lastDom.elements.get(id);
  	  if (!element)
  	...
  	function renderTag(injectedScript, role, name, id, params) {
  	  ...
  	  const escapedValue = injectedScript.utils.escapeHTMLAttribute((params == null ? undefined : params.value) || "");
  	  switch (role) {
  	    case "button":
  	...
  	var InjectedScript = class {
  	  ...
  	  builtinSetTimeout(callback, timeout) {
  	    var _a;
  	    if ((_a = this.window.__pwClock) == null ? undefined : _a.builtin)
  	  ...
  	  expectHitTarget(hitPoint, targetElement) {
  	    ...
  	    for (let index = roots.length - 1; index >= 0; index--) {
  	      ...
  	      if (singleElement && elements[0] && parentElementOrShadowHost(singleElement) === elements[0]) {
  	        ...
  	        if ((style == null ? undefined : style.display) === "contents") {
...
`);
  	  ...
  	  _setupHitTargetInterceptors() {
  	    const listener = (event) => {
  	      var _a;
  	      return (_a = this._hitTargetInterceptor) == null ? undefined : _a.call(this, event);
  	    };
  	    ...
  	    const expression = options.expression;
  	    {
  	      ...
  	      if (expression === "to.have.attribute") {
  	        ...
  	        if (element.nodeName === "INPUT" || element.nodeName === "TEXTAREA")
  	          ...
  	          elementState = !((_a = element.textContent) == null ? undefined : _a.trim());
  ...
  var injectedScriptExports = requireInjectedScript();

  const SelectorGenerator = injectedScriptExports.InjectedScript();
   ...
   */
  function getElementByPlaywrightSelector(selector) {
      try {
  ...
  exports.generatePlaywrightSelector = generatePlaywrightSelector;
  exports.getElementByPlaywrightSelector = getElementByPlaywrightSelector;
